...
import 'ops/email_api.dart';
import 'ops/tls_api.dart';
import 'ops/traffic_api.dart';
...
export 'ops/email_api.dart';
export 'ops/tls_api.dart';
export 'ops/traffic_api.dart';
...
class CfApi {
  ...
  late final email = EmailApi(client);
  late final tls = TlsApi(client);
